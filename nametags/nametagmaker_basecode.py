#!/usr/bin/env python
"""Kod för att skapa namnskyltar."""
from PIL import Image, ImageFont, ImageDraw


# Bearbetar textfilen till en lista men namn som element.
list_name = []
fil = open("gäster.txt", encoding='utf-8')
...
def make_nametag(list_of_names, paper_w, paper_h, num_w, num_h, font, fontsize, pagenum):
    """Skapar jpg-filer men namnskyltformat."""
    box_w = paper_w/num_w
    box_h = paper_h/num_h
    ...
    img = img.save("bröllopsgäster{}.jpg".format(pagenum))


def main(list_of_names, paper_w, paper_h, num_w, num_h, font, fontsize):
    """För att få individuela bald för namnskyltarna."""
    fil_num = 1
    fil_st = num_h*num_w
...
#main(list_name, 2480, 3508, 2, 5, "fonts/Demo_ConeriaScript.ttf",150)
#main(list_name, 2480, 3508, 2, 5, "fonts/Astrid.otf",150)
#main(list_name, 2480, 3508, 2, 5, "fonts/South Rattingson.otf",150)
main(list_name, 2480, 3508, 2, 5, "fonts/Arash.ttf",150)
